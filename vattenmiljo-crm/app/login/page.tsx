  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-cyan-50 px-4 sm:px-6 lg:px-8">
      ...
      <div className="fixed top-4 right-4 bg-red-500 text-white p-2 rounded text-sm z-50">
        CSS Test: {/* This should be red if Tailwind is working */}
        <span className="bg-green-500 px-2 ml-2 rounded">Tailwind OK</span>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="leojidah@hotmail.com"
                    value={email}
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Test med: leojidah@hotmail.com / TempPass123!
            </p>
          </div>
        </div>
      </div>
