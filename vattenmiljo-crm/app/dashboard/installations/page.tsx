...
export default function InstallationsDashboardPage() {
  ...
  useEffect(() => {
    ...
    if (!loading && profile && profile.role !== 'INSTALLER' && profile.role !== 'ADMIN') {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="flex items-center gap-2 text-gray-600">
          ...
          <span>Laddar installation dashboard...</span>
        </div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Du har inte behörighet att komma åt installation dashboard. 
            Denna funktion är endast tillgänglig för montörer och administratörer.
          </p>
          <Link
            href="/dashboard"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-lg font-medium text-gray-900">Installation Dashboard</h1>
            </div>
