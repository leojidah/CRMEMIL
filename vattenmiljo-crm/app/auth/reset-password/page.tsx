...
// Separera komponenten som använder useSearchParams
function ResetPasswordForm() {
  ...
  const searchParams = useSearchParams() // Nu är det här säkert i Suspense
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-gray-100 text-center">
          <div className="w-5 h-5 border-2 border-blue-500 border-t-transparent rounded-full animate-spin mx-auto mb-4" />
          <p className="text-gray-600">Laddar återställning...</p>
        </div>
      </div>
    }>
      <ResetPasswordForm />
